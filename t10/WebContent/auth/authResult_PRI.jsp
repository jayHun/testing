...
<p style="text-align: center;"><span style="font-size: 12.0pt;" id="dateInfo"></span></p>
<p style="text-align: right;"><span style="font-size: 12.0pt;" id ="reasonInfo"></span></p>
</td>
</tr>
<tr style="height: 26.65pt;">
<td style="width: 99.25pt; border-top: none; border-left: solid #0070C0 2.25pt; border-bottom: solid #0070C0 1.0pt; border-right: solid #0070C0 1.0pt; background: #DAEEF3; padding: 0cm 5.4pt 0cm 5.4pt; height: 26.65pt;" width="132">
...
<p style="text-align: center;"><span style="font-size: 12.0pt;" id="identity"></span></p>
</td>
...
//var from = $('#addr').val();
	...
	$('#transferDate').html('<span style="font-size: 12.0pt;">' + transferDate + '</span>');
	$('#houseAddr').html('<span style="font-size: 12.0pt;">' + houseAddr + '</span>');
	$('#rowNum').html('<span style="font-size: 12.0pt;">' + "1" + '</span>');
	$('#relation').html('<span style="font-size: 12.0pt;">' + householderRelation + '</span>');
	$('#name').html('<span style="font-size: 12.0pt;">' + householderName + '</span>');
	$('#identity').html('<span style="font-size: 12.0pt;">' + identity + '</span>'); 
	$('#date').html('<span style="font-size: 12.0pt;">' + transferDate + "  " + transferDate + '</span>'); 
	$('#reason').html('<span style="font-size: 12.0pt;">' + tranferReason + '</span>');
	$('#dateInfo').html('<span style="font-size: 12.0pt;">' + transferDate + "  " + transferDate + '</span>'); 
	$('#reasonInfo').html('<span style="font-size: 12.0pt;">' + tranferReason + '</span>'); 
	
	for(var idx = familyCount-1; idx >= 0; idx--){
		var familyInfo = contract.getFamily.call(idx);
		...
		htmltag += '<p style="text-align: center;"><span style="font-size: 12.0pt;">' + (Number(idx)+2) + '</span></p>';
		htmltag += '</td>';
		...
		htmltag += '<p style="text-align: center;"><span style="font-size: 12.0pt;">'+ familyInfo[4] +'</span></p>';
		htmltag += '</td>';
		htmltag += '<td style="width: 77.95pt; border-top: none; border-left: none; border-bottom: solid #0070C0 1.0pt; border-right: inset white 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 26.65pt;" width="104">';
		htmltag += '<p style="text-align: center;"><span style="font-size: 12.0pt;">'+ familyInfo[0] + '</span></p>';
		htmltag += '</td>';
		htmltag += '<td style="width: 120.5pt; border-top: none; border-left: none; border-bottom: solid #0070C0 1.0pt; border-right: inset white 1.0pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 26.65pt;" colspan="2" width="161">';
		htmltag += '<p style="text-align: center;"><span style="font-size: 12.0pt;">'+ familyInfo[1] +'</span></p>';
		htmltag += '</td>';
		...
		htmltag += '<p style="text-align: center;"><span style="font-size: 12.0pt;">'+ familyInfo[2] + "  " + familyInfo[2]+'</span></p>';
		htmltag += '</td>';
		...
		htmltag += '<p style="text-align: center;"><span style="font-size: 12.0pt;">'+ familyInfo[3] +'</span></p>';
		htmltag += '</td>';
		htmltag += '</tr>';
		
		$('#firstRow').after(htmltag);
	}
